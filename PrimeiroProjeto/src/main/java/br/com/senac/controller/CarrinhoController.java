...
import br.com.senac.service.ItemPedidoService;
import br.com.senac.service.PagamentoService;
import br.com.senac.service.PedidoService;
	...
	public String finalizar(HttpSession session) throws ParseException, ObjectNotFoundException {
		...
		try {
			...
			Pagamento pag = new PagamentoComBoleto(null, StatusPagamento.PENDENTE, pedido,
					sdf.parse("01/12/2018 14:00"), sdf.parse("17/12/2018 16:00"));
			...
			return "carrinho/finalizarCarrinho.html";
